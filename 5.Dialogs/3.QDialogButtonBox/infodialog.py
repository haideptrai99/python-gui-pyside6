...
class InfoDialog(QDialog, Ui_InfoDialog):
    ...
    def button_box_clicked(self, button):
        ...
        if std_button == QDialogButtonBox.StandardButton.Ok:
            ...
            self.accept()
        elif std_button == QDialogButtonBox.StandardButton.Cancel:
            self.reject()
        elif std_button == QDialogButtonBox.StandardButton.Save:
            print("Save")
        elif std_button == QDialogButtonBox.StandardButton.SaveAll:
            print("SaveAll")
        elif std_button == QDialogButtonBox.StandardButton.Open:
            print("Open")
        else:
